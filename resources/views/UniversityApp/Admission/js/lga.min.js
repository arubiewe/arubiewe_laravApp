...
const setAttributes = (a, o) =>
	...
	{
		let o = {
            Abia: ["Aba", "Aba South", "Arochukwu", "Bende", "Ikwuano", "Isiala Ngwa North", "Isiala Ngwa South", "Isuikwuato", "Obi Ngwa", "Ohafia", "Osisioma", "Ugwunagbo", "Ukwa East", "Ukwa West", "Umuahia North", "muahia South", "Umu Nneochi"],
		...
		u.forEach(a =>
		{
			...
			o.appendChild(document.createTextNode(a)), o.value = a, a.includes("elect") && setAttributes(o,
			{
				disabled: "disabled",
				selected: "selected"
			}), e.appendChild(o)
